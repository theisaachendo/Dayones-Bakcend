...
import { UserNotification } from '@app/modules/user/modules/user-notifications/entities/user-notifications.entity';
import { UserDeviceService } from '@app/modules/user/services/user-device.service';

@Module({
  imports: [
    TypeOrmModule.forFeature([Notifications, UserDevice, UserNotification]),
    ConfigModule,
  ],
